  ...
  return (
    <header className="bg-white border-gray-200 light:bg-gray-900 shadow text-white p-2 flex justify-between items-center">
      ...
      <div className="relative">
        ...
        className="flex profile_btn text-sm font-medium text-gray-900 rounded-full hover:text-blue-600 dark:hover:text-blue-500 md:mr-0 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-white">
